    ...
    >
      ...
      <GridContainer className="grid-1-1-1">
        <WrapperContainer2
          padding={0}
          gap={30}
          className="graph-option-wrapper"
        >
          <FaDatabase />
          <DropCard
            ...
            searchBox={true}
            onClick={(event) =>
              handleInputChange("selectedColumn", event, setGraphValues)
            }
            seeAllOption={false}
          />
        </WrapperContainer2>
        ...
        >
          ...
          <DropCard
            ...
            onClick={(event) =>
              handleInputChange("graphType", event, setGraphValues)
            }
          />
        </WrapperContainer2>
        ...
        >
          ...
          <DropCard
            ...
            onClick={(event) =>
              handleInputChange("indexAxis", event, setGraphValues)
            }
          />
        </WrapperContainer2>
      </GridContainer>
