...
const FormTextRecommendations = () => {
    return (
        <WrapperContainer2 flexDirection="column" padding={0} gap={10}>
            ...
            <TextCard fontSize={14}><SpanCard fontSize={14}> - Tipo de Datos:</SpanCard> El archivo debe contener únicamente datos relacionados con Disciplinas, Municipios u Ofertas de Empleo.</TextCard>
